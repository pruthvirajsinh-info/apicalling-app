...
function Pokemon() {
	...
	const getPokemonInfo = useCallback(
		async (image: string) => {
			...
			let evolutionLevel = evolution.find(
	...
	return (
		<div>
			{crntPokemonTab === pokemonTabs.description && <Description />}
			{crntPokemonTab === pokemonTabs.evolution && <Evolution />}
			{crntPokemonTab === pokemonTabs.moves && <CapableMoves />}
			{crntPokemonTab === pokemonTabs.locations && <Locations />}
		</div>
	);
}
